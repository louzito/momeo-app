...
class StaffMember
{
    ...
    /** @var array<string, list<array{start: string, end: string}>|array{enabled: bool, start: string, end: string}> */
    ...
    /** @return array<string, list<array{start: string, end: string}>|array{enabled: bool, start: string, end: string}> */
    public function getWorkingHours(): array { return $this->workingHours; }
    /** @param array<string, list<array{start: string, end: string}>|array{enabled: bool, start: string, end: string}> $workingHours */
