...
const ADMIN_EMAIL = process.env.TODATEMPO_ADMIN_EMAIL || process.env.SKYBOOK_ADMIN_EMAIL
const ADMIN_PASSWORD = process.env.TODATEMPO_ADMIN_PASSWORD || process.env.SKYBOOK_ADMIN_PASSWORD
if (!ADMIN_EMAIL || !ADMIN_PASSWORD) {
  throw new Error('TODATEMPO_ADMIN_EMAIL et TODATEMPO_ADMIN_PASSWORD sont obligatoires')
}
